...
<nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 relative w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 {{fontNameForArabic($locale, 'font-plex', 'font-mono')}} ">
    ...
    <div class="flex md:order-2">
        <button type="button" class="text-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg
         text-sm px-5 py-2.5 text-center mr-3 md:mr-0">{{__('Become a Blogger')}}</button>
