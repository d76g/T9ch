    ...
    <footer class="p-4 bg-dark-blue text-Mygray rounded-lg shadow md:px-6 md:py-8 dark:bg-Mygray-900 w-11/12">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="/home" class="flex items-center mb-4 sm:mb-0">
                ...
                <span class="self-center whitespace-nowrap dark:text-white font-jomhuria text-3xl">{{__('t9chnih')}}</span>
            </a>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="https://github.com/d76g" target="_blank" class="text-Mygray-500 hover:text-Mygray-900 dark:hover:text-white">
