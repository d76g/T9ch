        ...
        <div class="flex flex-col justify-center items-center w-full text-right">
            <div class="w-11/12 md:w-5/6 flex flex-col justify-center bg-slate-50 rounded-md my-4 py-4 px-6 drop-shadow-lg">
                ...
                <form id="blog-form" wire:submit.prevent="BlogUpdated" class="w-full flex flex-col justify-center items-center" enctype="multipart/form-data">
                    ...
                    <div class="w-11/12 flex flex-col justify-center items-center">
                        <div class="flex flex-col w-full">
                            ...
                            <div class="flex" x-data="{ showImage: false }">
                                ...
                                <span class="text-xs hover:text-blue cursor-pointer" @click="showImage = ! showImage"><i class="fa fa-eye px-1"></i>Show image</span>
                                @endif
                                <span wire:click="removeImage" class="text-xs hover:text-blue cursor-pointer"><i class="fa fa-trash px-1 text-red"></i>Remove Image</span>
                                @if ($blogPhoto !== null)
                    ...
                    <div class="w-11/12">
                        <button 
                        wire:click="BlogUpdated" class="text-white bg-blue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save</button>
                    </div>
                </form>
            </div>
        </div>
