        ...
        <div class="w-3/4 h-full flex flex-col items-center">
            <div class="bg-white w-full max-w-6xl h-30 mt-10 rounded-md">
                <div class="flex flex-col px-4 py-5 gap-y-2">
                    <span class="text-3xl font-bold text-dark-blue"># {{$category->category}}</span>
                    <span class="font-plex text-slate-500">{{$category->desc}}</span>
                </div>
            </div>
            {{-- Search Bar --}}
        ...
        <div class="w-1/4 h-fit flex flex-col pr-8 items-center">
            ...
            <div class="w-11/12 mt-40">
                <div class="w-full h-8 flex items-center mb-3">
                    <p class="text-3xl font-bold text-dark-blue"># Other Categories</p>
                </div>
            <div class="h-auto grid grid-cols-3 grid-rows-auto bg-white gap-1 rounded-md p-3 drop-shadow-sm">
                ...
                @endphp
                    <a href="/category/{{$item->slug}}" class="{{$colorClass}} p-2 rounded-lg text-white flex justify-center items-center text-center hover:scale-105 transition ease-in-out">
                        <p class="text-sm font-bold">{{$item->category}}</p>
                    </a>
                @endforeach
            </div>
            </div>
